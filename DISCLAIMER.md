# Disclaimer & Acceptable Use — pumasi

`pumasi` is part of the [gptaku-plugins](https://github.com/fivetaku/gptaku_plugins)
collection and is distributed under the [MIT License](./LICENSE).
Copyright (c) 2026 chulrolee.
...
`pumasi` is a general-purpose developer tool. Like most general-purpose tools, it
